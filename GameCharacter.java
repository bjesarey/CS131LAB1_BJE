...
/**
 * This is the base GameCharacter object from which all other characters will be
 * derived.
 * 
...
public class GameCharacter {
	...
	// instance variables - visibility is protected so subclasses can manipulate the
	// data directly.
	...
	/**
	 * The empty argument constructor generates an ID by calling a static method
	 * from the GameUtilities class
	 */
	...
	/**
	 * This constructor allows the caller to pass in the uniqueID for the object.
	 * 
	 * @param uniqueID
	 */
	...
	/**
	 * Returns the structure of the object in a specially formatted representation.
	 * This is the preferred method for printing out the object structure.
	 * 
	 * @return
	 */
	...
	public String Exclaim() {
		...
		return exclamation[(int) (Math.random() * 5)];
	}// end Exclaim
	...
	/**
	 * Used for test purposes only using the toString format generated by Eclipse.
	 */
	@Override
